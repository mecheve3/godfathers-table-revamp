import svgPaths from "./svg-eq2pq2zscz";

function Group2() {
  return (
    <div className="absolute contents left-[730px] top-[757px]">
      <div className="absolute bg-[#d9d9d9] border border-black border-solid h-[77px] left-[730px] top-[757.1px] w-[460px]" />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[757.04px] not-italic text-[64px] text-black top-[757px] whitespace-nowrap">GO TO LOBBY</p>
    </div>
  );
}
