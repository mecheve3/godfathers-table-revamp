...
export default function StartScreen() {
  ...
  const options = [
    { label: 'Quick Match', handler: handleQuickMatch, delay: 0.1 },
    { label: 'Create Match', handler: handleCreateMatch, delay: 0.2 },
    { label: 'Join Match', handler: handleJoinMatch, delay: 0.3 },
  ]
